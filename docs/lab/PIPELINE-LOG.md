...
| S01G | b93cb364663850cc1636945d18513a8209ae2138 | HOLD | T-1G-01…08 written. Apps=`gemini-apps`, CLI=`gemini-cli`, never merged. Missing one family ≠ unauth of the other. No Gemini card. Fabricated resetAt rejected. §16 FAIL list empty. Execution `BLOCKED_PENDING_REAL_MAC_EVIDENCE`. Allowed HOLD — continue. |
